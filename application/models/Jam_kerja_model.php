...
class Jam_kerja_model extends CI_Model{
  ...
  var $table = 'tbl_jam_kerja';
  var $view = 'tbl_jam_kerja';
  var $column_order = array('id', 'nama_hari', 'jam_masuk', 'jam_pulang', 'input_by', 'input_datetime', 'is_del', 'client_id');
  var $column_search = array('id', 'nama_hari', 'jam_masuk', 'jam_pulang', 'input_by', 'input_datetime', 'is_del', 'client_id');
