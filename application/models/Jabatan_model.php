...
class Jabatan_model extends CI_Model{
  ...
  var $view = 'tbl_jabatan';
  var $column_order = array('id', 'nama_jabatan', 'keterangan', 'input_by', 'input_datetime', 'is_del', 'client_id');
  var $column_search = array('id', 'nama_jabatan', 'keterangan', 'input_by', 'input_datetime', 'is_del', 'client_id');
