...
class Jenis_berkas_model extends CI_Model{
  ...
  var $table = 'tbl_jenis_berkas';
  var $view = 'tbl_jenis_berkas';
  var $column_order = array('id', 'nama_jenis_berkas');
  var $column_search = array('id', 'nama_jenis_berkas');
  var $order = array('nama_jenis_berkas', 'asc');
