...
class Departemen_model extends CI_Model{
  ...
  var $view = 'tbl_departemen';
  var $column_order = array('id', 'kode_departemen', 'nama_departemen', 'keterangan' ,'input_by', 'input_datetime', 'is_del', 'client_id');
  var $column_search = array('id', 'kode_departemen', 'nama_departemen', 'keterangan', 'input_by', 'input_datetime', 'is_del', 'client_id');
