...
class Shift_karyawan_model extends CI_Model{

  var $table = 'tbl_shift_karyawan';
  var $view = 'tbl_shift_karyawan';
  var $column_order = array('id', 'id_shift', 'id_karyawan', 'tanggal', 'input_by', 'input_datetime', 'is_del', 'client_id');
  var $column_search = array('id', 'id_shift', 'id_karyawan', 'tanggal', 'input_by', 'input_datetime', 'is_del', 'client_id');
