...
class Transfer_kas_model extends CI_Model{

  var $table = 'view_transaksi_transfer_kas';
  var $column_order = array('id', 'kd_trans', 'tgl_catat', 'tgl_catat_asli', 'tgl_catat_search', 'keterangan', 'nama_dari_kas_id', 'nama_untuk_kas_id', 'jumlah', 'user_name');
  var $column_search = array('id', 'kd_trans', 'tgl_catat', 'tgl_catat_asli', 'tgl_catat_search', 'keterangan', 'nama_dari_kas_id', 'nama_untuk_kas_id', 'jumlah', 'user_name');
