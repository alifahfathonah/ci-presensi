...
class Profil_model extends CI_Model{
  ...
  var $view = 'tbl_profil';
  var $column_order = array('id', 'nama_perusahaan', 'alamat_perusahaan', 'logo', 'deksripsi', 'input_by', 'input_datetime', 'is_del', 'client_id');
  var $column_search = array('id', 'nama_perusahaan', 'alamat_perusahaan', 'logo', 'deksripsi', 'input_by', 'input_datetime', 'is_del', 'client_id');
