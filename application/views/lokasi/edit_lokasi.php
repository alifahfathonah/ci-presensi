...
<div class="col-md-12">
  <div class="card ">
    <div class="card-header card-header-success card-header-text">
      ...
      <h4 class="card-title">Form Edit Data Lokasi Absen</h4>
    </div>
            ...
            <div class="row">
              ...
              <div class="col-sm-8">
                <div class="form-group label-floating " id="input_nama_lokasi_error_container">
                  ...
                  <input type="text"  class="form-control" id="input_nama_lokasi" name="input_nama_lokasi" value="<?php echo $record['nama_lokasi']; ?>"/>
            ...
            <div class="row">
              ...
              <div class="col-sm-8">
                <div class="form-group label-floating " id="input_latitude_error_container">
                  ...
                  <input type="text"  class="form-control" id="input_latitude" name="input_latitude" value="<?php echo $record['lat']; ?>" />
                  <span class="form-control-feedback">
            ...
            <div class="row">
              ...
              <div class="col-sm-8">
                <div class="form-group label-floating " id="input_longitude_error_container">
                  ...
                  <input type="text"  class="form-control" id="input_longitude" name="input_longitude"  value="<?php echo $record['lon']; ?>"/>
                  <span class="form-control-feedback">
            ...
            <div class="row">
              ...
              <div class="col-sm-8">
                <div class="form-group label-floating " id="input_radius_error_container">
                  ...
                  <input type="text"  class="form-control" id="input_radius" name="input_radius"  value="<?php echo $record['radius']; ?>"/>
                  <span class="form-control-feedback">
