...
<div class="col-md-12" style="padding:0; margin: 0;">
  <div class="card ">
    ...
    <div class="card-body ">
      <form method="post" class="form-horizontal" id="form-presensi-masuk" enctype="multipart/form-data" action="<?php echo base_url('user/pulang'); ?>">
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="row">
              ...
              <div class="col-md-4">
                <input type="hidden" name="input_id_record" id="input_id_record" value="<?php echo $today_attendance['id'] ?>">  
