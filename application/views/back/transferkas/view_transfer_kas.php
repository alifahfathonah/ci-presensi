...
<div class="content mt-3">
  <div class="card" style="border-top: solid 3px #7ea4b3">
    <div class="card-body card-block">
      <h5 class="card-title display-4" style="font-size: 25px">Data Transaksi transfer Kas</h5>
      ...
      <div class="table-responsive">
        <table id="table_transferkas" class="table table-hover table-striped table-sm small" style="width:100%" >
  ...
  <div class="modal fade" tabindex="-1" role="dialog" id="modal_add_trans_transfer_kas">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form id="form_trans_transfer_kas">
            ...
            <div class="form-group row">
              <label for="inputEmail3" class="col-sm-4 col-form-label">Transfer Ke Kas</label>
              <div class="col-sm-8">
                <?php
                $where = array('tmpl_pemasukan' => 'Y' );
                // cmb_dinamis($pilih,$name,$table,$field,$order_by,$pk,$where,$selected=null, $action=null)
