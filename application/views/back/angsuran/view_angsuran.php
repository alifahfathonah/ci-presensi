							...
							<div class="card-body">
								...
								<form id="form_pembayaran_angsuran">
									...
									<div class="form-group row">
										...
										<div class="col-sm-6">
											<input type="text" class="form-control form-control-sm" name="input_nomor_pinjaman" id="input_nomor_pinjaman" readonly style="background: white; border: none" value="<?php echo 'TPJ' . sprintf('%05d', $this->uri->segment(3)) . '' ?>">
									...
									<div class="form-group row">
										...
										<div class="col-sm-6">
											<input type="text" class="form-control form-control-sm" name="input_jumlah_angsuran" id="input_jumlah_angsuran" readonly style="background: white; border: none" value="<?php echo rupiah(nsi_round($row_pinjam->ags_per_bulan)); ?>">
										</div>
									</div>
						...
						<div class="card">
							<div class="card-body">
								...
								<div class="form-group row">
									...
									<div class="col-sm-6">
										<input readonly type="text" class="form-control form-control-sm" id="input_simpanan_wajib" name="input_simpanan_wajib" value="<?php echo number_format(0); ?>">
										<input readonly type="text" class="form-control form-control-sm" id="input_simpanan_wajib_hidden" name="input_simpanan_wajib_hidden" value="<?php echo number_format($sim_wajib); ?>">
									</div>
								</div>
								...
								<div class="form-group row">
									...
									<div class="col-sm-6">
										<input readonly type="text" class="form-control form-control-sm" id="input_simpanan_sukarela" name="input_simpanan_sukarela" value="<?php echo number_format(0); ?>">
										<input readonly type="text" class="form-control form-control-sm" id="input_simpanan_sukarela_hidden" name="input_simpanan_sukarela_hidden" value="<?php echo number_format($sim_sukarela); ?>">
									</div>
								</div>
