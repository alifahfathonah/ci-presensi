...
<div class="content mt-3">
    <div class="card" style="border-top: solid 3px #7ea4b3">
        <div class="card-body card-block">
            <h5 class="card-title display-4" style="font-size: 25px">Cetak Laporan Laba Rugi</h5>
            <div class="input-group input-group-sm" id="prefetch">
                <div class="input-group-append" id="button-addon4">
                    ...
                    <a class="btn btn-outline-secondary" role="button" href="<?php echo base_url('labarugi') ?>"><b class="fa fa-times"></b> Hapus Filter</a>
                </div>
            </div>
            <hr>

            <div id="content_labarugi">
