...
<div class="content mt-3">
  <div class="card" style="border-top: solid 3px #7ea4b3">
    <div class="card-body card-block">
      <h5 class="card-title display-4" style="font-size: 25px">Data Transaksi Pengeluaran Kas</h5>
      ...
      <div class="table-responsive">
        <table id="table_pengeluarankas" class="table table-hover table-striped table-sm small" style="width:100%" >
  ...
  <div class="modal fade" tabindex="-1" role="dialog" id="modal_add_trans_pengeluaran_kas">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form id="form_trans_pengeluaran_kas">
            ...
            <div class="form-group row">
              <label for="inputEmail3" class="col-sm-4 col-form-label">Dari Kas</label>
              <div class="col-sm-8">
                <?php
                $where = array('tmpl_pemasukan' => 'Y' );
                // cmb_dinamis($pilih,$name,$table,$field,$order_by,$pk,$where,$selected=null, $action=null)
                echo cmb_dinamis_2('-- Pilih Kas --','input_dari_kas','nama_kas_tbl','nama','nama','id',$where);
                ?>
                <small id="input_dari_kas_error" class="text-danger"></small>
              </div>
            </div>

            <div class="form-group row">
              <label for="inputEmail3" class="col-sm-4 col-form-label">Untuk Akun </label>
              <div class="col-sm-8">
                <?php
                $where = array('pemasukan' => 'Y' );
                echo cmb_dinamis_3('-- Pilih Jenis Akun --','input_untuk_akun','jns_akun','jns_trans','kd_aktiva','id',$where);
                ?>
                <small id="input_untuk_akun_error" class="text-danger"></small>
              </div>
            </div>
