...
<div class="col-md-12">
  <div class="card ">
    <div class="card-header card-header-success card-header-text">
      ...
      <h4 class="card-title">Form Edit Data Kantor</h4>
    </div>
            ...
            <div class="row">
              ...
              <div class="col-sm-8">
                <div class="form-group label-floating " id="input_nama_kantor_error_container">
                  ...
                  <input type="text"  class="form-control" id="input_nama_kantor" name="input_nama_kantor" value="<?php echo $record['nama_kantor']; ?>"/>
              ...
              <div class="col-sm-8">
                <div class="form-group label-floating " id="input_jenis_kantor_error_container">
                  ...
                  <select class="form-control" id="input_jenis_kantor" name="input_jenis_kantor">
                    ...
                    <?php
                    $id_jenis_kantor = $record['id_jenis_kantor'];
                    foreach ($jenis_kantor->result() as $r) {
                      $selected = ($id_jenis_kantor == $r->id) ? 'selected' : '' ;
                      echo '<option '.$selected.' value="'.$r->id.'">'.$r->nama_jenis_kantor.'</option>';
                    }
                    ?>
                  </select>
                  <span class="form-control-feedback">
            ...
            <div class="row">
              ...
              <div class="col-sm-8">
                <div class="form-group label-floating " id="input_alamat_error_container">
                  ...
                  <input type="text"  class="form-control" id="input_alamat" name="input_alamat" value="<?php echo $record['alamat_kantor']; ?>"/>
                  <span class="form-control-feedback">
                ...
                <div class="form-group label-floating " id="input_provinsi_error_container">
                  ...
                  <select class="form-control" id="input_provinsi" name="input_provinsi" onchange="get_kota()">
                    ...
                    foreach ($provinsi->result() as $r) {
                      $selected = ($id_provinsi == $r->id) ? 'selected' : '' ;
                ...
                <div class="form-group label-floating " id="input_kota_error_container">
                  ...
                  <select class="form-control" id="input_kota" name="input_kota" >
                    ...
                    foreach ($kabupaten->result() as $r) {
                      $selected = ($id_kota == $r->id) ? 'selected' : '' ;
                      echo '<option '.$selected.' value="'.$r->id.'">'.$r->name.'</option>';
                    }
                    ?>
                  </select>
            ...
            <div class="row">
              ...
              <div class="col-sm-8">
                <div class="form-group label-floating " id="input_no_telp_1_error_container">
                  ...
                  <input type="text"  class="form-control" id="input_no_telp_1" name="input_no_telp_1" value="<?php echo $record['no_telp_1']; ?>" />
                  <span class="form-control-feedback">
            ...
            <div class="row">
              ...
              <div class="col-sm-8">
                <div class="form-group label-floating " id="input_no_telp_2_error_container">
                  ...
                  <input type="text"  class="form-control" id="input_no_telp_2" name="input_no_telp_2" value="<?php echo $record['no_telp_2']; ?>"/>
                  <span class="form-control-feedback">
