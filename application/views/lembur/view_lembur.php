    ...
    <div class="card">
      ...
      <div class="card-header card-header-info d-flex flex-row align-items-center">
        ...
        <!-- <div class="btn-group btn-group-sm ml-auto" role="group" aria-label="Basic example">
          <a role="button" target="_self" class="btn btn-sm btn-secondary text-success" href="<?php echo base_url('lembur/add');?>"><b class="fa fa-plus"></b> Tambah</a>
        </div> -->

      </div>
      <div class="card-body table-responsive">
        <?php echo $this->session->flashdata('message'); ?>
        <table class="table table-hover table-striped" id="table_lembur" style="width:100%">
      ...
      <div class="modal-body">
        <div class="card " style="box-shadow: 0 0.5rem 1rem rgba(0, 0, 0, 0.5);">
          ...
          <div class="card-body ">
            ...
            <div class="row ">
              ...
              <div class="col-sm-6">
                <div class="form-group label-floating " id="input_departemen_filter_error_container">
                  <select class="form-control" id="input_departemen_filter" name="input_departemen_filter" onchange="getKaryawanByDept()">
            ...
            <div class="row ">
              <label class="col-sm-6 col-form-label" for="input_karyawan_filter">Karyawan</label>
              <div class="col-sm-6">
                <div class="form-group label-floating " id="input_karyawan_filter_error_container">
                  <select class="form-control" id="input_karyawan_filter" name="input_karyawan_filter" >
                    <option value="x" selected>All</option>
                  </select>
                </div>
              </div>
          ...
          <div class="card-footer">
            ...
            <button type="button" class="btn btn-success btn-sm" onclick="search()">Cari</button>
          </div>
        </div>
      </div>
    </div>
