...
<div class="col-md-12">
  <div class="card ">
    <div class="card-header card-header-success card-header-text">
      ...
      <h4 class="card-title">Form Edit Data Departemen</h4>
    </div>
            ...
            <div class="row">
              ...
              <div class="col-sm-8">
                <div class="form-group label-floating " id="input_kode_departemen_error_container">
                  ...
                  <input type="text"  class="form-control" id="input_kode_departemen" name="input_kode_departemen" value="<?php echo $record['kode_departemen']; ?>"/>
            ...
            <div class="row">
              ...
              <div class="col-sm-8">
                <div class="form-group label-floating " id="input_nama_departemen_error_container">
                  ...
                  <input type="text"  class="form-control" id="input_nama_departemen" name="input_nama_departemen" value="<?php echo $record['nama_departemen']; ?>"/>
                  <span class="form-control-feedback">
