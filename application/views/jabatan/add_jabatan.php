      ...
      <form method="post" class="form-horizontal" id="form-jabatan" onSubmit="return false;">
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="row">
              <label class="col-sm-4 col-form-label" for="input_nama_jabatan">Nama Departemen</label>
              <div class="col-sm-8">
                <div class="form-group label-floating " id="input_nama_jabatan_error_container">
                  ...
                  <input type="text"  class="form-control" id="input_nama_jabatan" name="input_nama_jabatan" />
